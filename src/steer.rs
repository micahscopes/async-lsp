//! This module provides traits and implementations for routing LSP requests, notifications,
//! and events to appropriate services.
//!
//! The main components of this module are:
//!
//! - `LspPicker`: A trait for implementing custom service selection strategies.
//! - `FirstComeFirstServe`: A basic implementation of `LspPicker` that selects the first
//!   service that can handle a given request, notification, or event.
//! - `LspSteer`: A struct that manages multiple LSP services and uses a picker to route
//!   operations to the appropriate service.
//!
//! These components work together to provide a flexible routing system for LSP operations,
//! allowing for custom logic in service selection and management of multiple services.
